$('#search').keyup(function () {
    ...
    var urlForJson = "http://localhost:56334/api/talents";
    ...
    var urlForCloudImage = "https://res.cloudinary.com/askarmujhib/image/upload/v1592993383/Talent/";
    ...
    $.getJSON(urlForJson, function (data) {
        ...
        $.each(data, function (key, val) {
			...
			(val.Bio.search(myExp) != -1)) {
                ...
                output += '<img src=' + urlForCloudImage + val.ShortName + ".jpg alt=" + val.Name + '" />';
                output += '<p>' + val.Bio + '</p>';
                output += '</li>';
            }
        });
